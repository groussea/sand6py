...
#%%
N=7
selectedRuns1,selectedDict=d6py.whereSand6OutFromParms(listNumRun,runNumber=N,dimSim=3)
...
# selectedRuns=[selectedRuns1[0],selectedRuns1[1],selectedRuns1[2]]
selectedRuns=selectedRuns1
