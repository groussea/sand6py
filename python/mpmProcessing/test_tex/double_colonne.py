...
colors = [(33./255, 66./255, 99./255, 0.1),
...
vis = opyf.Render.CLAHEbrightness(runExp1.video.vis, 90)
...
[line2D] = ax2.plot(smooth(contrs[0][:, 0],5), smooth(contrs[0][:, 1],5), linestyle='-', color='purple', linewidth=1.2, alpha=0.7, label="Exp.")
...
lost = (Vini[i]-V)/Vini[i]*100
sR.plotContour(ax2, levels=[0.5], linewidths=1.2, linestyles='-.')
