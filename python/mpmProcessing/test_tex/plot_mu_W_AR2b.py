...
R_2d, selectedDict = d6py.whereSand6OutFromParms(listNumRun,  runNumber=Nrun, dimSim=2, delta_mu=0.0,delta_mu_start=0,keyWord='fracH=_R_2.0_')

R_3di, selectedDict = d6py.whereSand6OutFromParms(listNumRun,  runNumber=Nrun, dimSim=3, delta_mu=0.0,delta_mu_start=0,keyWord='R_2.0_B00_no_bed_0.12_HR')
indx=np.argsort([sR.dConfig['box'][1] for sR in  R_3d])
R_3d=[R_3di[i] for i in indx]
# R_2d, selectedDict = d6py.whereSand6OutFromParms(listNumRun,  runNumber=Nrun, dimSim=2, delta_mu=0.0,delta_mu_start=0,keyWord='fracH=_R_6.0_')

# R_3d, selectedDict = d6py.whereSand6OutFromParms(listNumRun,  runNumber=Nrun, dimSim=3, delta_mu=0.0,delta_mu_start=0,keyWord='R_6_B00_no_bed_0.12')
