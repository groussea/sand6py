...
fig.legend(h1 +[line2D]  , l1 +[r"Exp. free surf."] , fontsize=leg_fontsize,loc=3, framealpha=0.,edgecolor='w',facecolor='w',ncol=3,bbox_to_anchor=(0.04, 0.01, 0.4, 0.2))



fig.savefig(driveFolder+"/TAF/TAF_inria/INRIA_current_work/GitLab/dry-granular-all/dry-granular/doc/article/figures/"+fignames[Nrun]+"_muI.pdf", dpi=150)
plt.show()
# %%
